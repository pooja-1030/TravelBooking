...
const PredictiveSuggestionsPage = () => {
  ...
  const seasonData = {
    spring: [
      ...
      { dest: 'Washington D.C.', why: 'National Cherry Blossom Festival', dates: 'Mar 20 - Apr 14', popularity: 88, emoji: '' },
      { dest: 'Marrakech, Morocco', why: 'Comfortable temps before summer heat', dates: 'Mar - May', popularity: 65, emoji: '' },
    ],
    summer: [
      { dest: 'Santorini, Greece', why: 'Peak Mediterranean summer vibes', dates: 'Jun - Aug', popularity: 96, emoji: '' },
      { dest: 'Bali, Indonesia', why: 'Dry season with perfect surf conditions', dates: 'Jun - Sep', popularity: 90, emoji: '' },
      { dest: 'Reykjavik, Iceland', why: 'Midnight sun & whale watching', dates: 'Jun - Aug', popularity: 82, emoji: '' },
    ...
    fall: [
      ...
      { dest: 'Patagonia, Argentina', why: 'Spring wildflowers in the south', dates: 'Oct - Nov', popularity: 75, emoji: '' },
    ...
    winter: [
      ...
      { dest: 'Swiss Alps', why: 'World-class skiing & cozy chalets', dates: 'Dec - Mar', popularity: 94, emoji: '' },
      { dest: 'Maldives', why: 'Dry season, perfect island weather', dates: 'Dec - Apr', popularity: 91, emoji: '' },
